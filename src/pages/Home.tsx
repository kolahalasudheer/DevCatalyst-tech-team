      ...
      <main className="relative">
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8">
              ...
              <div className="mt-8 grid md:grid-cols-3 gap-6 text-gray-300">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Matrusri Engineering College</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <footer className="py-12 px-4 text-center">
          <div className="flex justify-center gap-8 mb-8">
            <a href="mailto:devcatalyst.2025@gmail.com" className="text-2xl text-gray-400 hover:text-[#00d4ff] hover:-translate-y-1 transition-all duration-300">✉️</a>
